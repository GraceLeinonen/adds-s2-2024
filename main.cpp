...
int main() {
    ...
    std::string num1String = "800";
    std::string num2String = "750";

    std::list<int> num1 = calc.buildBigNum(num1String);
    std::list<int> num2 = calc.buildBigNum(num2String);

    std::list<int> difference = calc.sub(num1, num2);

    for (std::list<int>::iterator it = difference.begin(); it != difference.end(); ++it) {
        std::cout << *it << " ";  
    }
